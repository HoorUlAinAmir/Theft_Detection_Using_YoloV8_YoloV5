...
# ─── PHOTO TRACKING ────────────────────────────────────────
photo_entry_saved  = False   # zone mein aane ki photo
photo_middle_saved = False   # andar hone ki photo (50 frames baad)
photo_exit_saved   = False   # zone se nikalne ki photo
middle_frame_count = 0       # andar kitne frames guzre
was_in_zone        = False   # pichle frame mein tha ya nahi
...
model_size_mb = os.path.getsize('yolov8n.pt') / (1024 * 1024)
